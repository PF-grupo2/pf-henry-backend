...
export const products = [
  {
    ...
    price: 120.99,
    description:
      "Zapatillas deportivas para correr con tecnología Air Max de Nike.",
    stock: 50,
    offer: 14,
    scoreAvg: 4.5,
    status: true,
  ...
  },
  {
    ...
    price: 139.99,
    description:
      "Zapatillas deportivas para correr con tecnología Ultraboost de Adidas.",
    stock: 30,
    offer: 26,
    scoreAvg: 4.8,
    status: true,
  ...
  },
  {
    ...
    price: 89.99,
    description:
      "botines de fútbol Puma One, ideales para jugar en césped natural.",
    stock: 20,
    offer: 24,
    scoreAvg: 4.2,
    status: true,
  ...
  },
  {
    ...
    price: 99.99,
    description:
      "Zapatillas de entrenamiento Reebok Nano, diseñadas para levantamiento de pesas y entrenamientos funcionales.",
    stock: 40,
    offer: 21,
    scoreAvg: 4.4,
    status: true,
  ...
  },
  {
    ...
    price: 149.99,
    description:
      "Zapatillas de running Asics Gel Nimbus con amortiguación de gel para una carrera suave y cómoda.",
    stock: 25,
    offer: 12,
    scoreAvg: 4.7,
    status: true,
    ...
    gender: "Unisex",
    style: "Running",
    size: [35, 36, 39, 40, 42, 46, 47],
    color: ["Amarillo", "Verde", "Rojo", "Rosado"],
    images: [
  ...
  },
  {
    ...
    price: 129.99,
    description:
      "botas de senderismo Merrell Moab, impermeables y resistentes para aventuras al aire libre.",
    stock: 35,
    offer: 21,
    scoreAvg: 4.6,
    status: true,
    ...
    color: ["Verde"],
    images: [
      "https://www.outletmerrellargentina.com.ar/images/outletmerrellargentina/botas_De_Monta%C3%b1a_Merrell_Moab_2_Mid_Vent-Argentina-0296742.jpg",
      "https://www.outletmerrellargentina.com.ar/images/outletmerrellargentina/botas_De_Monta%C3%b1a_Merrell_Moab_2_Mid_GORE-Argentina-9648372.jpg",
      "https://www.outletmerrellargentina.com.ar/images/outletmerrellargentina/botas_De_Monta%C3%b1a_Merrell_Moab_3_Mid_GORE-Argentina-2482679.jpg",
    ],
  },
  {
    ...
    price: 109.99,
    description:
      "Zapatillas de running New balance Fresh Foam con una entresuela suave para una amortiguación superior.",
    stock: 15,
    offer: 11,
    scoreAvg: 4.3,
    status: true,
    ...
    color: ["Gris", "Rosado"],
    images: [
      "https://www.newbalance.com.ar/on/demandware.static/-/Sites-siteCatalog_NBEU/default/dw3745fa02/new_images/N10225075/N10225075-1.jpeg",
      "https://www.newbalance.com.ar/on/demandware.static/-/Sites-siteCatalog_NbEU/default/dwf866e6bf/new_images/N10225075/N10225075-1.jpeg",
      "https://www.newbalance.com.ar/on/demandware.static/-/Sites-siteCatalog_NbEU/default/dw8b5bd2dd/new_images/N10225075/N10225075070822/N10225075070822-1.jpeg",
    ],
  },
  {
    ...
    price: 129.99,
    description:
      "Zapatillas de running Under Armour HOVR con tecnología de amortiguación y retorno de energía.",
    stock: 20,
    offer: 18,
    scoreAvg: 4.6,
    status: true,
  ...
  },
  {
    ...
    price: 79.99,
    description:
      "botines de fútbol Nike Tiempo Legend con cuero premium para un toque de balón excepcional.",
    stock: 10,
    offer: 21,
    scoreAvg: 4.1,
    status: true,
  ...
  },
  {
    ...
    price: 139.99,
    description:
      "Zapatillas de trail running Salomon Speedcross con agarre agresivo para terrenos difíciles.",
    stock: 20,
    offer: 24,
    scoreAvg: 4.5,
    status: true,
  ...
  },
  {
    ...
    price: 129.99,
    description:
      "Zapatillas de running Mizuno Wave Rider con una combinación perfecta de amortiguación y sujeción.",
    stock: 30,
    offer: 18,
    scoreAvg: 4.4,
    status: true,
  ...
  },
  {
    ...
    price: 119.99,
    description:
      "Zapatillas de running brooks Ghost con una amortiguación suave y transpirable.",
    stock: 25,
    offer: 14,
    scoreAvg: 4.6,
    status: true,
  ...
  },
  {
    ...
    price: 159.99,
    description:
      "botas de senderismo Timberland Chocorua resistentes al agua y duraderas.",
    stock: 15,
    offer: 10,
    scoreAvg: 4.7,
    status: true,
    ...
    style: "Outdoor",
    size: [37, 42, 44],
    color: ["Blanco", "Rojo", "Negro", "Azul", "Verde", "Violeta"],
    images: [
  ...
  },
  {
    ...
    price: 89.99,
    description:
      "Zapatillas de running Skechers Go Run con una entresuela ligera y flexible.",
    stock: 20,
    offer: 28,
    scoreAvg: 4.2,
    status: true,
    ...
    style: "Running",
    size: [39],
    color: ["Blanco", "Negro", "Rosado", "Amarillo"],
    images: [
  ...
  },
  {
    ...
    price: 109.99,
    description:
      "Zapatillas de senderismo Columbia Redmond con una construcción duradera y resistente.",
    stock: 20,
    offer: 20,
    scoreAvg: 4.5,
    status: true,
    ...
    gender: "Hombre",
    style: "Outdoor",
    size: [39, 40, 41, 42, 43, 45, 47],
    color: ["Negro", "Azul", "Verde", "Gris"],
    images: [
  ...
  },
  {
    ...
    price: 99.99,
    description:
      "botines de fútbol Adidas Predator con tecnología de control de balón.",
    stock: 25,
    offer: 14,
    scoreAvg: 4.4,
    status: true,
    ...
    style: "Futbol",
    size: [42, 45, 46, 47, 48],
    color: ["Blanco", "Negro", "Rosado", "Gris", "Verde"],
    images: [
  ...
  },
  {
    ...
    price: 159.99,
    description:
      "Zapatillas de running Hoka One One Clifton con una amortiguación excepcionalmente suave.",
    stock: 20,
    offer: 27,
    scoreAvg: 4.6,
    status: true,
  ...
  },
  {
    ...
    gender: "Unisex",
    style: "Outdoor",
    size: [36, 38, 39, 40, 42, 44],
    color: ["Verde", "Negro", "Violeta"],
    images: [
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRz7QC9W5sGkRe3LK4DA3xumdjO20bgEudSAWLhukLz80ObqQbVMw4Kgtta2SjJWTjKrc&usqp=CAU",
  ...
  },
  {
    ...
    price: 99.99,
    description:
      "Zapatillas de running Under Armour Charged Assert con amortiguación y soporte.",
    stock: 30,
    offer: 18,
    scoreAvg: 4.3,
    status: true,
  ...
  },
  {
    ...
    price: 79.99,
    description:
      "Zapatillas de running Puma Ignite con entresuela de espuma para mayor comodidad.",
    stock: 40,
    offer: 26,
    scoreAvg: 4.2,
    status: true,
    ...
    style: "Running",
    size: [37, 38, 39, 40],
    color: ["Azul", "Rojo", "Verde", "Amarillo", "Violeta"],
    images: [
